    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_coordinates', models.DecimalField(decimal_places=10, max_digits=18, null=True)),
                ('y_coordinates', models.DecimalField(decimal_places=10, max_digits=18, null=True)),
